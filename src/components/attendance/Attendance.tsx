            ...
            <table className="w-full">
              <thead>
                <tr className="text-left border-b border-slate-100">
                  ...
                  <th className="pb-6 text-xs-bold-uppercase text-slate-400 hidden md:table-cell">Grau</th>
                  <th className="pb-6 text-xs-bold-uppercase text-slate-400 text-center hidden sm:table-cell">Presenças</th>
                  <th className="pb-6 text-xs-bold-uppercase text-slate-400 text-center hidden sm:table-cell">Faltas</th>
                    ...
                    <tr key={stat.id} className="table-row-hover">
                      <td className="py-4 pl-4">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider md:hidden">{stat.degree}</span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 text-right pr-4">
                        {isExempt ? (
                          ...
                          <div className="flex items-center justify-end space-x-2 md:space-x-3">
                            <div className="w-12 md:w-20 h-1.5 bg-slate-100 rounded-full overflow-hidden hidden xs:block">
                              <div 
          ...
          <table className="w-full">
            <thead>
              <tr className="text-left border-b border-slate-100">
                ...
                <th className="pb-6 text-xs-bold-uppercase text-slate-400 hidden sm:table-cell">Descrição</th>
                ...
                <tr key={s.id} className="table-row-hover">
                  <td className="py-4 md:py-6 pl-4">
                    ...
                    <td className="py-4 md:py-6 hidden sm:table-cell">
                      {s.description && <span className="text-[10px] text-slate-400 italic line-clamp-1">{s.description}</span>}
                    </td>
                    <td className="py-4 md:py-6 text-right pr-4">
                      <div className="flex items-center justify-end space-x-1 md:space-x-2">
                        <button 
                          ...
                          className="p-1.5 md:p-2 text-slate-400 hover:text-amber-500 hover:bg-amber-50 rounded-xl transition-all"
                          title="Ver Presenças"
                        >
                          <Eye size={16} />
                        </button>
